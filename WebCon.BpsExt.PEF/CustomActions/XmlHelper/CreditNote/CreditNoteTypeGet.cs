...
namespace WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote
{
    ...
    public class CreditNoteTypeGet
    {
        public void GetField(CreditNoteType creditnotetype, IXmlMapping xmlMapping)
        {
            ...
            {
                case "UBLExtensions":
                    if (creditnotetype.UBLExtensions == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingUBLExtensions)
                    {
                        foreach (var row in creditnotetype.UBLExtensions)
                        {
                    ...
                    {
                        GetField(creditnotetype.UBLExtensions[0], xmlMapping);
                    }
                    break;
                case "UBLVersionID":
                    if (creditnotetype.UBLVersionID == null) return;
                    GetField(creditnotetype.UBLVersionID, xmlMapping);
                    break;
                case "CustomizationID":
                    if (creditnotetype.CustomizationID == null) return;
                    GetField(creditnotetype.CustomizationID, xmlMapping);
                    break;
                case "ProfileID":
                    if (creditnotetype.ProfileID == null) return;
                    GetField(creditnotetype.ProfileID, xmlMapping);
                    break;
                case "ProfileExecutionID":
                    if (creditnotetype.ProfileExecutionID == null) return;
                    GetField(creditnotetype.ProfileExecutionID, xmlMapping);
                    break;
                case "ID":
                    if (creditnotetype.ID == null) return;
                    GetField(creditnotetype.ID, xmlMapping);
                    break;
                case "CopyIndicator":
                    if (creditnotetype.CopyIndicator == null) return;
                    GetField(creditnotetype.CopyIndicator, xmlMapping);
                    break;
                case "UUID":
                    if (creditnotetype.UUID == null) return;
                    GetField(creditnotetype.UUID, xmlMapping);
                    break;
                case "IssueDate":
                    if (creditnotetype.IssueDate == null) return;
                    GetField(creditnotetype.IssueDate, xmlMapping);
                    break;
                case "IssueTime":
                    if (creditnotetype.IssueTime == null) return;
                    GetField(creditnotetype.IssueTime, xmlMapping);
                    break;
                case "TaxPointDate":
                    if (creditnotetype.TaxPointDate == null) return;
                    GetField(creditnotetype.TaxPointDate, xmlMapping);
                    break;
                case "CreditNoteTypeCode":
                    if (creditnotetype.CreditNoteTypeCode == null) return;
                    GetField(creditnotetype.CreditNoteTypeCode, xmlMapping);
                    break;
                case "Note":
                    if (creditnotetype.Note == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingNote)
                    {
                        foreach (var row in creditnotetype.Note)
                        {
                    ...
                    {
                        GetField(creditnotetype.Note[0], xmlMapping);
                    }
                    break;
                case "DocumentCurrencyCode":
                    if (creditnotetype.DocumentCurrencyCode == null) return;
                    GetField(creditnotetype.DocumentCurrencyCode, xmlMapping);
                    break;
                case "TaxCurrencyCode":
                    if (creditnotetype.TaxCurrencyCode == null) return;
                    GetField(creditnotetype.TaxCurrencyCode, xmlMapping);
                    break;
                case "PricingCurrencyCode":
                    if (creditnotetype.PricingCurrencyCode == null) return;
                    GetField(creditnotetype.PricingCurrencyCode, xmlMapping);
                    break;
                case "PaymentCurrencyCode":
                    if (creditnotetype.PaymentCurrencyCode == null) return;
                    GetField(creditnotetype.PaymentCurrencyCode, xmlMapping);
                    break;
                case "PaymentAlternativeCurrencyCode":
                    if (creditnotetype.PaymentAlternativeCurrencyCode == null) return;
                    GetField(creditnotetype.PaymentAlternativeCurrencyCode, xmlMapping);
                    break;
                case "AccountingCostCode":
                    if (creditnotetype.AccountingCostCode == null) return;
                    GetField(creditnotetype.AccountingCostCode, xmlMapping);
                    break;
                case "AccountingCost":
                    if (creditnotetype.AccountingCost == null) return;
                    GetField(creditnotetype.AccountingCost, xmlMapping);
                    break;
                case "LineCountNumeric":
                    if (creditnotetype.LineCountNumeric == null) return;
                    GetField(creditnotetype.LineCountNumeric, xmlMapping);
                    break;
                case "BuyerReference":
                    if (creditnotetype.BuyerReference == null) return;
                    GetField(creditnotetype.BuyerReference, xmlMapping);
                    break;
                case "InvoicePeriod":
                    if (creditnotetype.InvoicePeriod == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingInvoicePeriod)
                    {
                        foreach (var row in creditnotetype.InvoicePeriod)
                        {
                    ...
                    {
                        GetField(creditnotetype.InvoicePeriod[0], xmlMapping);
                    }
                    break;
                case "DiscrepancyResponse":
                    if (creditnotetype.DiscrepancyResponse == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDiscrepancyResponse)
                    {
                        foreach (var row in creditnotetype.DiscrepancyResponse)
                        {
                            collMappingDiscrepancyResponse.SetNewRowContext();
                    ...
                    {
                        GetField(creditnotetype.DiscrepancyResponse[0], xmlMapping);
                    }
                    break;
                case "OrderReference":
                    if (creditnotetype.OrderReference == null) return;
                    GetField(creditnotetype.OrderReference, xmlMapping);
                    break;
                case "BillingReference":
                    if (creditnotetype.BillingReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingBillingReference)
                    {
                        foreach (var row in creditnotetype.BillingReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.BillingReference[0], xmlMapping);
                    }
                    break;
                case "DespatchDocumentReference":
                    if (creditnotetype.DespatchDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDespatchDocumentReference)
                    {
                        foreach (var row in creditnotetype.DespatchDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.DespatchDocumentReference[0], xmlMapping);
                    }
                    break;
                case "ReceiptDocumentReference":
                    if (creditnotetype.ReceiptDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingReceiptDocumentReference)
                    {
                        foreach (var row in creditnotetype.ReceiptDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.ReceiptDocumentReference[0], xmlMapping);
                    }
                    break;
                case "ContractDocumentReference":
                    if (creditnotetype.ContractDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingContractDocumentReference)
                    {
                        foreach (var row in creditnotetype.ContractDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.ContractDocumentReference[0], xmlMapping);
                    }
                    break;
                case "AdditionalDocumentReference":
                    if (creditnotetype.AdditionalDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingAdditionalDocumentReference)
                    {
                        foreach (var row in creditnotetype.AdditionalDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.AdditionalDocumentReference[0], xmlMapping);
                    }
                    break;
                case "StatementDocumentReference":
                    if (creditnotetype.StatementDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingStatementDocumentReference)
                    {
                        foreach (var row in creditnotetype.StatementDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.StatementDocumentReference[0], xmlMapping);
                    }
                    break;
                case "OriginatorDocumentReference":
                    if (creditnotetype.OriginatorDocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingOriginatorDocumentReference)
                    {
                        foreach (var row in creditnotetype.OriginatorDocumentReference)
                        {
                    ...
                    {
                        GetField(creditnotetype.OriginatorDocumentReference[0], xmlMapping);
                    }
                    break;
                case "Signature":
                    if (creditnotetype.Signature == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingSignature)
                    {
                        foreach (var row in creditnotetype.Signature)
                        {
                    ...
                    {
                        GetField(creditnotetype.Signature[0], xmlMapping);
                    }
                    break;
                case "AccountingSupplierParty":
                    if (creditnotetype.AccountingSupplierParty == null) return;
                    GetField(creditnotetype.AccountingSupplierParty, xmlMapping);
                    break;
                case "AccountingCustomerParty":
                    if (creditnotetype.AccountingCustomerParty == null) return;
                    GetField(creditnotetype.AccountingCustomerParty, xmlMapping);
                    break;
                case "PayeeParty":
                    if (creditnotetype.PayeeParty == null) return;
                    GetField(creditnotetype.PayeeParty, xmlMapping);
                    break;
                case "BuyerCustomerParty":
                    if (creditnotetype.BuyerCustomerParty == null) return;
                    GetField(creditnotetype.BuyerCustomerParty, xmlMapping);
                    break;
                case "SellerSupplierParty":
                    if (creditnotetype.SellerSupplierParty == null) return;
                    GetField(creditnotetype.SellerSupplierParty, xmlMapping);
                    break;
                case "TaxRepresentativeParty":
                    if (creditnotetype.TaxRepresentativeParty == null) return;
                    GetField(creditnotetype.TaxRepresentativeParty, xmlMapping);
                    break;
                case "Delivery":
                    if (creditnotetype.Delivery == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDelivery)
                    {
                        foreach (var row in creditnotetype.Delivery)
                        {
                    ...
                    {
                        GetField(creditnotetype.Delivery[0], xmlMapping);
                    }
                    break;
                case "DeliveryTerms":
                    if (creditnotetype.DeliveryTerms == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDeliveryTerms)
                    {
                        foreach (var row in creditnotetype.DeliveryTerms)
                        {
                    ...
                    {
                        GetField(creditnotetype.DeliveryTerms[0], xmlMapping);
                    }
                    break;
                case "PaymentMeans":
                    if (creditnotetype.PaymentMeans == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentMeans)
                    {
                        foreach (var row in creditnotetype.PaymentMeans)
                        {
                    ...
                    {
                        GetField(creditnotetype.PaymentMeans[0], xmlMapping);
                    }
                    break;
                case "PaymentTerms":
                    if (creditnotetype.PaymentTerms == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentTerms)
                    {
                        foreach (var row in creditnotetype.PaymentTerms)
                        {
                    ...
                    {
                        GetField(creditnotetype.PaymentTerms[0], xmlMapping);
                    }
                    break;
                case "TaxExchangeRate":
                    if (creditnotetype.TaxExchangeRate == null) return;
                    GetField(creditnotetype.TaxExchangeRate, xmlMapping);
                    break;
                case "PricingExchangeRate":
                    if (creditnotetype.PricingExchangeRate == null) return;
                    GetField(creditnotetype.PricingExchangeRate, xmlMapping);
                    break;
                case "PaymentExchangeRate":
                    if (creditnotetype.PaymentExchangeRate == null) return;
                    GetField(creditnotetype.PaymentExchangeRate, xmlMapping);
                    break;
                case "PaymentAlternativeExchangeRate":
                    if (creditnotetype.PaymentAlternativeExchangeRate == null) return;
                    GetField(creditnotetype.PaymentAlternativeExchangeRate, xmlMapping);
                    break;
                case "AllowanceCharge":
                    if (creditnotetype.AllowanceCharge == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingAllowanceCharge)
                    {
                        foreach (var row in creditnotetype.AllowanceCharge)
                        {
                    ...
                    {
                        GetField(creditnotetype.AllowanceCharge[0], xmlMapping);
                    }
                    break;
                case "TaxTotal":
                    if (creditnotetype.TaxTotal == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingTaxTotal)
                    {
                        foreach (var row in creditnotetype.TaxTotal)
                        {
                    ...
                    {
                        GetField(creditnotetype.TaxTotal[0], xmlMapping);
                    }
                    break;
                case "LegalMonetaryTotal":
                    if (creditnotetype.LegalMonetaryTotal == null) return;
                    GetField(creditnotetype.LegalMonetaryTotal, xmlMapping);
                    break;
                case "CreditNoteLine":
                    if (creditnotetype.CreditNoteLine == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingCreditNoteLine)
                    {
                        foreach (var row in creditnotetype.CreditNoteLine)
                        {
                            collMappingCreditNoteLine.SetNewRowContext();
                    ...
                    {
                        GetField(creditnotetype.CreditNoteLine[0], xmlMapping);
                    }
                    break;
        ...
        public void GetField(ResponseType discrepancyresponse, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ReferenceID":
                    if (discrepancyresponse.ReferenceID == null) return;
                    GetField(discrepancyresponse.ReferenceID, xmlMapping);
                    break;
                case "ResponseCode":
                    if (discrepancyresponse.ResponseCode == null) return;
                    GetField(discrepancyresponse.ResponseCode, xmlMapping);
                    break;
                case "Description":
                    if (discrepancyresponse.Description == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDescription)
                    {
                        foreach (var row in discrepancyresponse.Description)
                        {
                            collMappingDescription.SetNewRowContext();
                    ...
                    {
                        GetField(discrepancyresponse.Description[0], xmlMapping);
                    }
                    break;
                case "EffectiveDate":
                    if (discrepancyresponse.EffectiveDate == null) return;
                    GetField(discrepancyresponse.EffectiveDate, xmlMapping);
                    break;
                case "EffectiveTime":
                    if (discrepancyresponse.EffectiveTime == null) return;
                    GetField(discrepancyresponse.EffectiveTime, xmlMapping);
                    break;
                case "Status":
                    if (discrepancyresponse.Status == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingStatus)
                    {
                        foreach (var row in discrepancyresponse.Status)
                        {
                    ...
                    {
                        GetField(discrepancyresponse.Status[0], xmlMapping);
                    }
                    break;

            }
        }
        public void GetField(StatusType status, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ConditionCode":
                    if (status.ConditionCode == null) return;
                    GetField(status.ConditionCode, xmlMapping);
                    break;
                case "ReferenceDate":
                    if (status.ReferenceDate == null) return;
                    GetField(status.ReferenceDate, xmlMapping);
                    break;
                case "ReferenceTime":
                    if (status.ReferenceTime == null) return;
                    GetField(status.ReferenceTime, xmlMapping);
                    break;
                case "Description":
                    if (status.Description == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDescription)
                    {
                        foreach (var row in status.Description)
                        {
                            collMappingDescription.SetNewRowContext();
                    ...
                    {
                        GetField(status.Description[0], xmlMapping);
                    }
                    break;
                case "StatusReasonCode":
                    if (status.StatusReasonCode == null) return;
                    GetField(status.StatusReasonCode, xmlMapping);
                    break;
                case "StatusReason":
                    if (status.StatusReason == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingStatusReason)
                    {
                        foreach (var row in status.StatusReason)
                        {
                    ...
                    {
                        GetField(status.StatusReason[0], xmlMapping);
                    }
                    break;
                case "SequenceID":
                    if (status.SequenceID == null) return;
                    GetField(status.SequenceID, xmlMapping);
                    break;
                case "Text":
                    if (status.Text == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingText)
                    {
                        foreach (var row in status.Text)
                        {
                    ...
                    {
                        GetField(status.Text[0], xmlMapping);
                    }
                    break;
                case "IndicationIndicator":
                    if (status.IndicationIndicator == null) return;
                    GetField(status.IndicationIndicator, xmlMapping);
                    break;
                case "Percent":
                    if (status.Percent == null) return;
                    GetField(status.Percent, xmlMapping);
                    break;
                case "ReliabilityPercent":
                    if (status.ReliabilityPercent == null) return;
                    GetField(status.ReliabilityPercent, xmlMapping);
                    break;
                case "Condition":
                    if (status.Condition == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingCondition)
                    {
                        foreach (var row in status.Condition)
                        {
                    ...
                    {
                        GetField(status.Condition[0], xmlMapping);
                    }
                    break;
        ...
        public void GetField(CreditNoteLineType creditnoteline, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ID":
                    if (creditnoteline.ID == null) return;
                    GetField(creditnoteline.ID, xmlMapping);
                    break;
                case "UUID":
                    if (creditnoteline.UUID == null) return;
                    GetField(creditnoteline.UUID, xmlMapping);
                    break;
                case "Note":
                    if (creditnoteline.Note == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingNote)
                    {
                        foreach (var row in creditnoteline.Note)
                        {
                            collMappingNote.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.Note[0], xmlMapping);
                    }
                    break;
                case "CreditedQuantity":
                    if (creditnoteline.CreditedQuantity == null) return;
                    GetField(creditnoteline.CreditedQuantity, xmlMapping);
                    break;
                case "LineExtensionAmount":
                    if (creditnoteline.LineExtensionAmount == null) return;
                    GetField(creditnoteline.LineExtensionAmount, xmlMapping);
                    break;
                case "TaxPointDate":
                    if (creditnoteline.TaxPointDate == null) return;
                    GetField(creditnoteline.TaxPointDate, xmlMapping);
                    break;
                case "AccountingCostCode":
                    if (creditnoteline.AccountingCostCode == null) return;
                    GetField(creditnoteline.AccountingCostCode, xmlMapping);
                    break;
                case "AccountingCost":
                    if (creditnoteline.AccountingCost == null) return;
                    GetField(creditnoteline.AccountingCost, xmlMapping);
                    break;
                case "PaymentPurposeCode":
                    if (creditnoteline.PaymentPurposeCode == null) return;
                    GetField(creditnoteline.PaymentPurposeCode, xmlMapping);
                    break;
                case "FreeOfChargeIndicator":
                    if (creditnoteline.FreeOfChargeIndicator == null) return;
                    GetField(creditnoteline.FreeOfChargeIndicator, xmlMapping);
                    break;
                case "InvoicePeriod":
                    if (creditnoteline.InvoicePeriod == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingInvoicePeriod)
                    {
                        foreach (var row in creditnoteline.InvoicePeriod)
                        {
                            collMappingInvoicePeriod.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.InvoicePeriod[0], xmlMapping);
                    }
                    break;
                case "OrderLineReference":
                    if (creditnoteline.OrderLineReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingOrderLineReference)
                    {
                        foreach (var row in creditnoteline.OrderLineReference)
                        {
                            collMappingOrderLineReference.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.OrderLineReference[0], xmlMapping);
                    }
                    break;
                case "DiscrepancyResponse":
                    if (creditnoteline.DiscrepancyResponse == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDiscrepancyResponse)
                    {
                        foreach (var row in creditnoteline.DiscrepancyResponse)
                        {
                            collMappingDiscrepancyResponse.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.DiscrepancyResponse[0], xmlMapping);
                    }
                    break;
                case "DespatchLineReference":
                    if (creditnoteline.DespatchLineReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDespatchLineReference)
                    {
                        foreach (var row in creditnoteline.DespatchLineReference)
                        {
                            collMappingDespatchLineReference.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.DespatchLineReference[0], xmlMapping);
                    }
                    break;
                case "ReceiptLineReference":
                    if (creditnoteline.ReceiptLineReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingReceiptLineReference)
                    {
                        foreach (var row in creditnoteline.ReceiptLineReference)
                        {
                            collMappingReceiptLineReference.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.ReceiptLineReference[0], xmlMapping);
                    }
                    break;
                case "BillingReference":
                    if (creditnoteline.BillingReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingBillingReference)
                    {
                        foreach (var row in creditnoteline.BillingReference)
                        {
                            collMappingBillingReference.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.BillingReference[0], xmlMapping);
                    }
                    break;
                case "DocumentReference":
                    if (creditnoteline.DocumentReference == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDocumentReference)
                    {
                        foreach (var row in creditnoteline.DocumentReference)
                        {
                            collMappingDocumentReference.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.DocumentReference[0], xmlMapping);
                    }
                    break;
                case "PricingReference":
                    if (creditnoteline.PricingReference == null) return;
                    GetField(creditnoteline.PricingReference, xmlMapping);
                    break;
                case "OriginatorParty":
                    if (creditnoteline.OriginatorParty == null) return;
                    GetField(creditnoteline.OriginatorParty, xmlMapping);
                    break;
                case "Delivery":
                    if (creditnoteline.Delivery == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDelivery)
                    {
                        foreach (var row in creditnoteline.Delivery)
                        {
                            collMappingDelivery.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.Delivery[0], xmlMapping);
                    }
                    break;
                case "PaymentTerms":
                    if (creditnoteline.PaymentTerms == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentTerms)
                    {
                        foreach (var row in creditnoteline.PaymentTerms)
                        {
                            collMappingPaymentTerms.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.PaymentTerms[0], xmlMapping);
                    }
                    break;
                case "TaxTotal":
                    if (creditnoteline.TaxTotal == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingTaxTotal)
                    {
                        foreach (var row in creditnoteline.TaxTotal)
                        {
                            collMappingTaxTotal.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.TaxTotal[0], xmlMapping);
                    }
                    break;
                case "AllowanceCharge":
                    if (creditnoteline.AllowanceCharge == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingAllowanceCharge)
                    {
                        foreach (var row in creditnoteline.AllowanceCharge)
                        {
                            collMappingAllowanceCharge.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.AllowanceCharge[0], xmlMapping);
                    }
                    break;
                case "Item":
                    if (creditnoteline.Item == null) return;
                    GetField(creditnoteline.Item, xmlMapping);
                    break;
                case "Price":
                    if (creditnoteline.Price == null) return;
                    GetField(creditnoteline.Price, xmlMapping);
                    break;
                case "DeliveryTerms":
                    if (creditnoteline.DeliveryTerms == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingDeliveryTerms)
                    {
                        foreach (var row in creditnoteline.DeliveryTerms)
                        {
                            collMappingDeliveryTerms.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.DeliveryTerms[0], xmlMapping);
                    }
                    break;
                case "SubCreditNoteLine":
                    if (creditnoteline.SubCreditNoteLine == null) return;
                    if (xmlMapping is IXmlCollectionMapping collMappingSubCreditNoteLine)
                    {
                        foreach (var row in creditnoteline.SubCreditNoteLine)
                        {
                            collMappingSubCreditNoteLine.SetNewRowContext();
                    ...
                    {
                        GetField(creditnoteline.SubCreditNoteLine[0], xmlMapping);
                    }
                    break;
                case "ItemPriceExtension":
                    if (creditnoteline.ItemPriceExtension == null) return;
                    GetField(creditnoteline.ItemPriceExtension, xmlMapping);
                    break;
