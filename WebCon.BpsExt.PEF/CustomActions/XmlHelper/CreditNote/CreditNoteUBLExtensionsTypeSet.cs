...
namespace WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNoteUBLExtensions
{
    ...
    public class CreditNoteUBLExtensionsTypeSet
    {
        public void SetField(OriginalInvoiceData invoicetype, IXmlMapping xmlMapping)
        {
        ...
        public void SetField(InvoiceCorrection invoicetype, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
