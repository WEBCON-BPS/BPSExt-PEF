...
namespace WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote
{
    ...
    public class CreditNoteTypeSet
    {

        public void SetField(CreditNoteType creditnotetype, IXmlMapping xmlMapping)
        {
            ...
            switch (xmlNode)
            {
                case "UBLExtensions":
                    ...
                    {
                        if (creditnotetype.UBLExtensions == null)
                            creditnotetype.UBLExtensions = new WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote.UBLExtensionType[collMappingUBLExtensions.Quantity];

                        for (int i = 0; i < collMappingUBLExtensions.Quantity; i++)
                        {
                            var row = creditnotetype.UBLExtensions[i] = new WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote.UBLExtensionType();
                    ...
                    else
                    {
                        if (creditnotetype.UBLExtensions == null)
                        {
                            creditnotetype.UBLExtensions = new WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote.UBLExtensionType[1];
                            creditnotetype.UBLExtensions[0] = new WebCon.BpsExt.PEF.CustomActions.XmlHelper.CreditNote.UBLExtensionType();
                        }
                        SetField(creditnotetype.UBLExtensions[0], xmlMapping);
                    }
                    break;
                case "UBLVersionID":
                    if (creditnotetype.UBLVersionID == null)
                        creditnotetype.UBLVersionID = new UBLVersionIDType();
                    SetField(creditnotetype.UBLVersionID, xmlMapping);
                    break;
                case "CustomizationID":
                    if (creditnotetype.CustomizationID == null)
                        creditnotetype.CustomizationID = new CustomizationIDType();
                    SetField(creditnotetype.CustomizationID, xmlMapping);
                    break;
                case "ProfileID":
                    if (creditnotetype.ProfileID == null)
                        creditnotetype.ProfileID = new ProfileIDType();
                    SetField(creditnotetype.ProfileID, xmlMapping);
                    break;
                case "ProfileExecutionID":
                    if (creditnotetype.ProfileExecutionID == null)
                        creditnotetype.ProfileExecutionID = new ProfileExecutionIDType();
                    SetField(creditnotetype.ProfileExecutionID, xmlMapping);
                    break;
                case "ID":
                    if (creditnotetype.ID == null)
                        creditnotetype.ID = new IDType();
                    SetField(creditnotetype.ID, xmlMapping);
                    break;
                case "CopyIndicator":
                    if (creditnotetype.CopyIndicator == null)
                        creditnotetype.CopyIndicator = new CopyIndicatorType();
                    SetField(creditnotetype.CopyIndicator, xmlMapping);
                    break;
                case "UUID":
                    if (creditnotetype.UUID == null)
                        creditnotetype.UUID = new UUIDType();
                    SetField(creditnotetype.UUID, xmlMapping);
                    break;
                case "IssueDate":
                    if (creditnotetype.IssueDate == null)
                        creditnotetype.IssueDate = new IssueDateType();
                    SetField(creditnotetype.IssueDate, xmlMapping);
                    break;
                case "IssueTime":
                    if (creditnotetype.IssueTime == null)
                        creditnotetype.IssueTime = new IssueTimeType();
                    SetField(creditnotetype.IssueTime, xmlMapping);
                    break;
                case "TaxPointDate":
                    if (creditnotetype.TaxPointDate == null)
                        creditnotetype.TaxPointDate = new TaxPointDateType();
                    SetField(creditnotetype.TaxPointDate, xmlMapping);
                    break;
                case "CreditNoteTypeCode":
                    if (creditnotetype.CreditNoteTypeCode == null)
                        creditnotetype.CreditNoteTypeCode = new CreditNoteTypeCodeType();
                    SetField(creditnotetype.CreditNoteTypeCode, xmlMapping);
                    break;
                case "Note":
                    if (xmlMapping is IXmlCollectionMapping collMappingNote && !collMappingNote.HasNextNode)
                    {
                        if (creditnotetype.Note == null)
                            creditnotetype.Note = new NoteType[collMappingNote.Quantity];

                        for (int i = 0; i < collMappingNote.Quantity; i++)
                        {
                            var row = creditnotetype.Note[i] = new NoteType();
                    ...
                    else
                    {
                        if (creditnotetype.Note == null)
                        {
                            creditnotetype.Note = new NoteType[1];
                            creditnotetype.Note[0] = new NoteType();
                        }
                        SetField(creditnotetype.Note[0], xmlMapping);
                    }
                    break;
                case "DocumentCurrencyCode":
                    if (creditnotetype.DocumentCurrencyCode == null)
                        creditnotetype.DocumentCurrencyCode = new DocumentCurrencyCodeType();
                    SetField(creditnotetype.DocumentCurrencyCode, xmlMapping);
                    break;
                case "TaxCurrencyCode":
                    if (creditnotetype.TaxCurrencyCode == null)
                        creditnotetype.TaxCurrencyCode = new TaxCurrencyCodeType();
                    SetField(creditnotetype.TaxCurrencyCode, xmlMapping);
                    break;
                case "PricingCurrencyCode":
                    if (creditnotetype.PricingCurrencyCode == null)
                        creditnotetype.PricingCurrencyCode = new PricingCurrencyCodeType();
                    SetField(creditnotetype.PricingCurrencyCode, xmlMapping);
                    break;
                case "PaymentCurrencyCode":
                    if (creditnotetype.PaymentCurrencyCode == null)
                        creditnotetype.PaymentCurrencyCode = new PaymentCurrencyCodeType();
                    SetField(creditnotetype.PaymentCurrencyCode, xmlMapping);
                    break;
                case "PaymentAlternativeCurrencyCode":
                    if (creditnotetype.PaymentAlternativeCurrencyCode == null)
                        creditnotetype.PaymentAlternativeCurrencyCode = new PaymentAlternativeCurrencyCodeType();
                    SetField(creditnotetype.PaymentAlternativeCurrencyCode, xmlMapping);
                    break;
                case "AccountingCostCode":
                    if (creditnotetype.AccountingCostCode == null)
                        creditnotetype.AccountingCostCode = new AccountingCostCodeType();
                    SetField(creditnotetype.AccountingCostCode, xmlMapping);
                    break;
                case "AccountingCost":
                    if (creditnotetype.AccountingCost == null)
                        creditnotetype.AccountingCost = new AccountingCostType();
                    SetField(creditnotetype.AccountingCost, xmlMapping);
                    break;
                case "LineCountNumeric":
                    if (creditnotetype.LineCountNumeric == null)
                        creditnotetype.LineCountNumeric = new LineCountNumericType();
                    SetField(creditnotetype.LineCountNumeric, xmlMapping);
                    break;
                case "BuyerReference":
                    if (creditnotetype.BuyerReference == null)
                        creditnotetype.BuyerReference = new BuyerReferenceType();
                    SetField(creditnotetype.BuyerReference, xmlMapping);
                    break;
                case "InvoicePeriod":
                    if (xmlMapping is IXmlCollectionMapping collMappingInvoicePeriod && !collMappingInvoicePeriod.HasNextNode)
                    {
                        if (creditnotetype.InvoicePeriod == null)
                            creditnotetype.InvoicePeriod = new PeriodType[collMappingInvoicePeriod.Quantity];

                        for (int i = 0; i < collMappingInvoicePeriod.Quantity; i++)
                        {
                            var row = creditnotetype.InvoicePeriod[i] = new PeriodType();
                    ...
                    else
                    {
                        if (creditnotetype.InvoicePeriod == null)
                        {
                            creditnotetype.InvoicePeriod = new PeriodType[1];
                            creditnotetype.InvoicePeriod[0] = new PeriodType();
                        }
                        SetField(creditnotetype.InvoicePeriod[0], xmlMapping);
                    }
                    break;
                case "DiscrepancyResponse":
                    if (xmlMapping is IXmlCollectionMapping collMappingDiscrepancyResponse && !collMappingDiscrepancyResponse.HasNextNode)
                    {
                        if (creditnotetype.DiscrepancyResponse == null)
                            creditnotetype.DiscrepancyResponse = new ResponseType[collMappingDiscrepancyResponse.Quantity];

                        for (int i = 0; i < collMappingDiscrepancyResponse.Quantity; i++)
                        {
                            var row = creditnotetype.DiscrepancyResponse[i] = new ResponseType();

                            foreach (var colMapp in collMappingDiscrepancyResponse.ColumnsMapping)
                            {
                                colMapp.SetRowContext(((XmlCollectionMapping)xmlMapping).itemsList.Rows[i]);
                                if (colMapp.Value != null && !string.IsNullOrEmpty(colMapp.Value.ToString()))
                                {
                    ...
                    else
                    {
                        if (creditnotetype.DiscrepancyResponse == null)
                        {
                            creditnotetype.DiscrepancyResponse = new ResponseType[1];
                            creditnotetype.DiscrepancyResponse[0] = new ResponseType();
                        }
                        SetField(creditnotetype.DiscrepancyResponse[0], xmlMapping);
                    }
                    break;
                case "OrderReference":
                    if (creditnotetype.OrderReference == null)
                        creditnotetype.OrderReference = new OrderReferenceType();
                    SetField(creditnotetype.OrderReference, xmlMapping);
                    break;
                case "BillingReference":
                    ...
                    {
                        if (creditnotetype.BillingReference == null)
                            creditnotetype.BillingReference = new BillingReferenceType[collMappingBillingReference.Quantity];

                        for (int i = 0; i < collMappingBillingReference.Quantity; i++)
                        {
                            var row = creditnotetype.BillingReference[i] = new BillingReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.BillingReference == null)
                        {
                            creditnotetype.BillingReference = new BillingReferenceType[1];
                            creditnotetype.BillingReference[0] = new BillingReferenceType();
                        }
                        SetField(creditnotetype.BillingReference[0], xmlMapping);
                    }
                    break;
                case "DespatchDocumentReference":
                    ...
                    {
                        if (creditnotetype.DespatchDocumentReference == null)
                            creditnotetype.DespatchDocumentReference = new DocumentReferenceType[collMappingDespatchDocumentReference.Quantity];

                        for (int i = 0; i < collMappingDespatchDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.DespatchDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.DespatchDocumentReference == null)
                        {
                            creditnotetype.DespatchDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.DespatchDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.DespatchDocumentReference[0], xmlMapping);
                    }
                    break;
                case "ReceiptDocumentReference":
                    ...
                    {
                        if (creditnotetype.ReceiptDocumentReference == null)
                            creditnotetype.ReceiptDocumentReference = new DocumentReferenceType[collMappingReceiptDocumentReference.Quantity];

                        for (int i = 0; i < collMappingReceiptDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.ReceiptDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.ReceiptDocumentReference == null)
                        {
                            creditnotetype.ReceiptDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.ReceiptDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.ReceiptDocumentReference[0], xmlMapping);
                    }
                    break;
                case "ContractDocumentReference":
                    ...
                    {
                        if (creditnotetype.ContractDocumentReference == null)
                            creditnotetype.ContractDocumentReference = new DocumentReferenceType[collMappingContractDocumentReference.Quantity];

                        for (int i = 0; i < collMappingContractDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.ContractDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.ContractDocumentReference == null)
                        {
                            creditnotetype.ContractDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.ContractDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.ContractDocumentReference[0], xmlMapping);
                    }
                    break;
                case "AdditionalDocumentReference":
                    ...
                    {
                        if (creditnotetype.AdditionalDocumentReference == null)
                            creditnotetype.AdditionalDocumentReference = new DocumentReferenceType[collMappingAdditionalDocumentReference.Quantity];

                        for (int i = 0; i < collMappingAdditionalDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.AdditionalDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.AdditionalDocumentReference == null)
                        {
                            creditnotetype.AdditionalDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.AdditionalDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.AdditionalDocumentReference[0], xmlMapping);
                    }
                    break;
                case "StatementDocumentReference":
                    ...
                    {
                        if (creditnotetype.StatementDocumentReference == null)
                            creditnotetype.StatementDocumentReference = new DocumentReferenceType[collMappingStatementDocumentReference.Quantity];

                        for (int i = 0; i < collMappingStatementDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.StatementDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.StatementDocumentReference == null)
                        {
                            creditnotetype.StatementDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.StatementDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.StatementDocumentReference[0], xmlMapping);
                    }
                    break;
                case "OriginatorDocumentReference":
                    ...
                    {
                        if (creditnotetype.OriginatorDocumentReference == null)
                            creditnotetype.OriginatorDocumentReference = new DocumentReferenceType[collMappingOriginatorDocumentReference.Quantity];

                        for (int i = 0; i < collMappingOriginatorDocumentReference.Quantity; i++)
                        {
                            var row = creditnotetype.OriginatorDocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnotetype.OriginatorDocumentReference == null)
                        {
                            creditnotetype.OriginatorDocumentReference = new DocumentReferenceType[1];
                            creditnotetype.OriginatorDocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnotetype.OriginatorDocumentReference[0], xmlMapping);
                    }
                    break;
                case "Signature":
                    if (xmlMapping is IXmlCollectionMapping collMappingSignature && !collMappingSignature.HasNextNode)
                    {
                        if (creditnotetype.Signature == null)
                            creditnotetype.Signature = new SignatureType[collMappingSignature.Quantity];

                        for (int i = 0; i < collMappingSignature.Quantity; i++)
                        {
                            var row = creditnotetype.Signature[i] = new SignatureType();
                    ...
                    else
                    {
                        if (creditnotetype.Signature == null)
                        {
                            creditnotetype.Signature = new SignatureType[1];
                            creditnotetype.Signature[0] = new SignatureType();
                        }
                        SetField(creditnotetype.Signature[0], xmlMapping);
                    }
                    break;
                case "AccountingSupplierParty":
                    if (creditnotetype.AccountingSupplierParty == null)
                        creditnotetype.AccountingSupplierParty = new SupplierPartyType();
                    SetField(creditnotetype.AccountingSupplierParty, xmlMapping);
                    break;
                case "AccountingCustomerParty":
                    if (creditnotetype.AccountingCustomerParty == null)
                        creditnotetype.AccountingCustomerParty = new CustomerPartyType();
                    SetField(creditnotetype.AccountingCustomerParty, xmlMapping);
                    break;
                case "PayeeParty":
                    if (creditnotetype.PayeeParty == null)
                        creditnotetype.PayeeParty = new PartyType();
                    SetField(creditnotetype.PayeeParty, xmlMapping);
                    break;
                case "BuyerCustomerParty":
                    if (creditnotetype.BuyerCustomerParty == null)
                        creditnotetype.BuyerCustomerParty = new CustomerPartyType();
                    SetField(creditnotetype.BuyerCustomerParty, xmlMapping);
                    break;
                case "SellerSupplierParty":
                    if (creditnotetype.SellerSupplierParty == null)
                        creditnotetype.SellerSupplierParty = new SupplierPartyType();
                    SetField(creditnotetype.SellerSupplierParty, xmlMapping);
                    break;
                case "TaxRepresentativeParty":
                    if (creditnotetype.TaxRepresentativeParty == null)
                        creditnotetype.TaxRepresentativeParty = new PartyType();
                    SetField(creditnotetype.TaxRepresentativeParty, xmlMapping);
                    break;
                case "Delivery":
                    if (xmlMapping is IXmlCollectionMapping collMappingDelivery && !collMappingDelivery.HasNextNode)
                    {
                        if (creditnotetype.Delivery == null)
                            creditnotetype.Delivery = new DeliveryType[collMappingDelivery.Quantity];

                        for (int i = 0; i < collMappingDelivery.Quantity; i++)
                        {
                            var row = creditnotetype.Delivery[i] = new DeliveryType();
                    ...
                    else
                    {
                        if (creditnotetype.Delivery == null)
                        {
                            creditnotetype.Delivery = new DeliveryType[1];
                            creditnotetype.Delivery[0] = new DeliveryType();
                        }
                        SetField(creditnotetype.Delivery[0], xmlMapping);
                    }
                    break;
                case "DeliveryTerms":
                    if (xmlMapping is IXmlCollectionMapping collMappingDeliveryTerms && !collMappingDeliveryTerms.HasNextNode)
                    {
                        if (creditnotetype.DeliveryTerms == null)
                            creditnotetype.DeliveryTerms = new DeliveryTermsType[collMappingDeliveryTerms.Quantity];

                        for (int i = 0; i < collMappingDeliveryTerms.Quantity; i++)
                        {
                            var row = creditnotetype.DeliveryTerms[i] = new DeliveryTermsType();
                    ...
                    else
                    {
                        if (creditnotetype.DeliveryTerms == null)
                        {
                            creditnotetype.DeliveryTerms = new DeliveryTermsType[1];
                            creditnotetype.DeliveryTerms[0] = new DeliveryTermsType();
                        }
                        SetField(creditnotetype.DeliveryTerms[0], xmlMapping);
                    }
                    break;
                case "PaymentMeans":
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentMeans && !collMappingPaymentMeans.HasNextNode)
                    {
                        if (creditnotetype.PaymentMeans == null)
                            creditnotetype.PaymentMeans = new PaymentMeansType[collMappingPaymentMeans.Quantity];

                        for (int i = 0; i < collMappingPaymentMeans.Quantity; i++)
                        {
                            var row = creditnotetype.PaymentMeans[i] = new PaymentMeansType();
                    ...
                    else
                    {
                        if (creditnotetype.PaymentMeans == null)
                        {
                            creditnotetype.PaymentMeans = new PaymentMeansType[1];
                            creditnotetype.PaymentMeans[0] = new PaymentMeansType();
                        }
                        SetField(creditnotetype.PaymentMeans[0], xmlMapping);
                    }
                    break;
                case "PaymentTerms":
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentTerms && !collMappingPaymentTerms.HasNextNode)
                    {
                        if (creditnotetype.PaymentTerms == null)
                            creditnotetype.PaymentTerms = new PaymentTermsType[collMappingPaymentTerms.Quantity];

                        for (int i = 0; i < collMappingPaymentTerms.Quantity; i++)
                        {
                            var row = creditnotetype.PaymentTerms[i] = new PaymentTermsType();
                    ...
                    else
                    {
                        if (creditnotetype.PaymentTerms == null)
                        {
                            creditnotetype.PaymentTerms = new PaymentTermsType[1];
                            creditnotetype.PaymentTerms[0] = new PaymentTermsType();
                        }
                        SetField(creditnotetype.PaymentTerms[0], xmlMapping);
                    }
                    break;
                case "TaxExchangeRate":
                    if (creditnotetype.TaxExchangeRate == null)
                        creditnotetype.TaxExchangeRate = new ExchangeRateType();
                    SetField(creditnotetype.TaxExchangeRate, xmlMapping);
                    break;
                case "PricingExchangeRate":
                    if (creditnotetype.PricingExchangeRate == null)
                        creditnotetype.PricingExchangeRate = new ExchangeRateType();
                    SetField(creditnotetype.PricingExchangeRate, xmlMapping);
                    break;
                case "PaymentExchangeRate":
                    if (creditnotetype.PaymentExchangeRate == null)
                        creditnotetype.PaymentExchangeRate = new ExchangeRateType();
                    SetField(creditnotetype.PaymentExchangeRate, xmlMapping);
                    break;
                case "PaymentAlternativeExchangeRate":
                    if (creditnotetype.PaymentAlternativeExchangeRate == null)
                        creditnotetype.PaymentAlternativeExchangeRate = new ExchangeRateType();
                    SetField(creditnotetype.PaymentAlternativeExchangeRate, xmlMapping);
                    break;
                case "AllowanceCharge":
                    ...
                    {
                        if (creditnotetype.AllowanceCharge == null)
                            creditnotetype.AllowanceCharge = new AllowanceChargeType[collMappingAllowanceCharge.Quantity];

                        for (int i = 0; i < collMappingAllowanceCharge.Quantity; i++)
                        {
                            var row = creditnotetype.AllowanceCharge[i] = new AllowanceChargeType();
                    ...
                    else
                    {
                        if (creditnotetype.AllowanceCharge == null)
                        {
                            creditnotetype.AllowanceCharge = new AllowanceChargeType[1];
                            creditnotetype.AllowanceCharge[0] = new AllowanceChargeType();
                        }
                        SetField(creditnotetype.AllowanceCharge[0], xmlMapping);
                    }
                    break;
                case "TaxTotal":
                    if (xmlMapping is IXmlCollectionMapping collMappingTaxTotal && !collMappingTaxTotal.HasNextNode)
                    {
                        if (creditnotetype.TaxTotal == null)
                            creditnotetype.TaxTotal = new TaxTotalType[collMappingTaxTotal.Quantity];

                        for (int i = 0; i < collMappingTaxTotal.Quantity; i++)
                        {
                            var row = creditnotetype.TaxTotal[i] = new TaxTotalType();
                    ...
                    else
                    {
                        if (creditnotetype.TaxTotal == null)
                        {
                            creditnotetype.TaxTotal = new TaxTotalType[1];
                            creditnotetype.TaxTotal[0] = new TaxTotalType();
                        }
                        SetField(creditnotetype.TaxTotal[0], xmlMapping);
                    }
                    break;
                case "LegalMonetaryTotal":
                    if (creditnotetype.LegalMonetaryTotal == null)
                        creditnotetype.LegalMonetaryTotal = new MonetaryTotalType();
                    SetField(creditnotetype.LegalMonetaryTotal, xmlMapping);
                    break;
                case "CreditNoteLine":
                    if (xmlMapping is IXmlCollectionMapping collMappingCreditNoteLine && !collMappingCreditNoteLine.HasNextNode)
                    {
                        if (creditnotetype.CreditNoteLine == null)
                            creditnotetype.CreditNoteLine = new CreditNoteLineType[collMappingCreditNoteLine.Quantity];

                        for (int i = 0; i < collMappingCreditNoteLine.Quantity; i++)
                        {
                            var row = creditnotetype.CreditNoteLine[i] = new CreditNoteLineType();

                            foreach (var colMapp in collMappingCreditNoteLine.ColumnsMapping)
                            {
                                colMapp.SetRowContext(((XmlCollectionMapping)xmlMapping).itemsList.Rows[i]);
                                if (colMapp.Value != null && !string.IsNullOrEmpty(colMapp.Value.ToString()))
                                {
                    ...
                    else
                    {
                        if (creditnotetype.CreditNoteLine == null)
                        {
                            creditnotetype.CreditNoteLine = new CreditNoteLineType[1];
                            creditnotetype.CreditNoteLine[0] = new CreditNoteLineType();
                        }
                        SetField(creditnotetype.CreditNoteLine[0], xmlMapping);
                    }
                    break;
        ...
        public void SetField(ResponseType discrepancyresponse, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ReferenceID":
                    if (discrepancyresponse.ReferenceID == null)
                        discrepancyresponse.ReferenceID = new ReferenceIDType();
                    SetField(discrepancyresponse.ReferenceID, xmlMapping);
                    break;
                case "ResponseCode":
                    if (discrepancyresponse.ResponseCode == null)
                        discrepancyresponse.ResponseCode = new ResponseCodeType();
                    SetField(discrepancyresponse.ResponseCode, xmlMapping);
                    break;
                case "Description":
                    if (xmlMapping is IXmlCollectionMapping collMappingDescription && !collMappingDescription.HasNextNode)
                    {
                        if (discrepancyresponse.Description == null)
                            discrepancyresponse.Description = new DescriptionType[collMappingDescription.Quantity];

                        for (int i = 0; i < collMappingDescription.Quantity; i++)
                        {
                            var row = discrepancyresponse.Description[i] = new DescriptionType();
                    ...
                    else
                    {
                        if (discrepancyresponse.Description == null)
                        {
                            discrepancyresponse.Description = new DescriptionType[1];
                            discrepancyresponse.Description[0] = new DescriptionType();
                        }
                        SetField(discrepancyresponse.Description[0], xmlMapping);
                    }
                    break;
                case "EffectiveDate":
                    if (discrepancyresponse.EffectiveDate == null)
                        discrepancyresponse.EffectiveDate = new EffectiveDateType();
                    SetField(discrepancyresponse.EffectiveDate, xmlMapping);
                    break;
                case "EffectiveTime":
                    if (discrepancyresponse.EffectiveTime == null)
                        discrepancyresponse.EffectiveTime = new EffectiveTimeType();
                    SetField(discrepancyresponse.EffectiveTime, xmlMapping);
                    break;
                case "Status":
                    if (xmlMapping is IXmlCollectionMapping collMappingStatus && !collMappingStatus.HasNextNode)
                    {
                        if (discrepancyresponse.Status == null)
                            discrepancyresponse.Status = new StatusType[collMappingStatus.Quantity];

                        for (int i = 0; i < collMappingStatus.Quantity; i++)
                        {
                            var row = discrepancyresponse.Status[i] = new StatusType();
                    ...
                    else
                    {
                        if (discrepancyresponse.Status == null)
                        {
                            discrepancyresponse.Status = new StatusType[1];
                            discrepancyresponse.Status[0] = new StatusType();
                        }
                        SetField(discrepancyresponse.Status[0], xmlMapping);
                    }
                    break;

            }
        }
        public void SetField(StatusType status, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ConditionCode":
                    if (status.ConditionCode == null)
                        status.ConditionCode = new ConditionCodeType();
                    SetField(status.ConditionCode, xmlMapping);
                    break;
                case "ReferenceDate":
                    if (status.ReferenceDate == null)
                        status.ReferenceDate = new ReferenceDateType();
                    SetField(status.ReferenceDate, xmlMapping);
                    break;
                case "ReferenceTime":
                    if (status.ReferenceTime == null)
                        status.ReferenceTime = new ReferenceTimeType();
                    SetField(status.ReferenceTime, xmlMapping);
                    break;
                case "Description":
                    if (xmlMapping is IXmlCollectionMapping collMappingDescription && !collMappingDescription.HasNextNode)
                    {
                        if (status.Description == null)
                            status.Description = new DescriptionType[collMappingDescription.Quantity];

                        for (int i = 0; i < collMappingDescription.Quantity; i++)
                        {
                            var row = status.Description[i] = new DescriptionType();
                    ...
                    else
                    {
                        if (status.Description == null)
                        {
                            status.Description = new DescriptionType[1];
                            status.Description[0] = new DescriptionType();
                        }
                        SetField(status.Description[0], xmlMapping);
                    }
                    break;
                case "StatusReasonCode":
                    if (status.StatusReasonCode == null)
                        status.StatusReasonCode = new StatusReasonCodeType();
                    SetField(status.StatusReasonCode, xmlMapping);
                    break;
                case "StatusReason":
                    if (xmlMapping is IXmlCollectionMapping collMappingStatusReason && !collMappingStatusReason.HasNextNode)
                    {
                        if (status.StatusReason == null)
                            status.StatusReason = new StatusReasonType[collMappingStatusReason.Quantity];

                        for (int i = 0; i < collMappingStatusReason.Quantity; i++)
                        {
                            var row = status.StatusReason[i] = new StatusReasonType();
                    ...
                    else
                    {
                        if (status.StatusReason == null)
                        {
                            status.StatusReason = new StatusReasonType[1];
                            status.StatusReason[0] = new StatusReasonType();
                        }
                        SetField(status.StatusReason[0], xmlMapping);
                    }
                    break;
                case "SequenceID":
                    if (status.SequenceID == null)
                        status.SequenceID = new SequenceIDType();
                    SetField(status.SequenceID, xmlMapping);
                    break;
                case "Text":
                    if (xmlMapping is IXmlCollectionMapping collMappingText && !collMappingText.HasNextNode)
                    {
                        if (status.Text == null)
                            status.Text = new TextType2[collMappingText.Quantity];

                        for (int i = 0; i < collMappingText.Quantity; i++)
                        {
                            var row = status.Text[i] = new TextType2();
                    ...
                    else
                    {
                        if (status.Text == null)
                        {
                            status.Text = new TextType2[1];
                            status.Text[0] = new TextType2();
                        }
                        SetField(status.Text[0], xmlMapping);
                    }
                    break;
                case "IndicationIndicator":
                    if (status.IndicationIndicator == null)
                        status.IndicationIndicator = new IndicationIndicatorType();
                    SetField(status.IndicationIndicator, xmlMapping);
                    break;
                case "Percent":
                    if (status.Percent == null)
                        status.Percent = new PercentType1();
                    SetField(status.Percent, xmlMapping);
                    break;
                case "ReliabilityPercent":
                    if (status.ReliabilityPercent == null)
                        status.ReliabilityPercent = new ReliabilityPercentType();
                    SetField(status.ReliabilityPercent, xmlMapping);
                    break;
                case "Condition":
                    if (xmlMapping is IXmlCollectionMapping collMappingCondition && !collMappingCondition.HasNextNode)
                    {
                        if (status.Condition == null)
                            status.Condition = new ConditionType1[collMappingCondition.Quantity];

                        for (int i = 0; i < collMappingCondition.Quantity; i++)
                        {
                            var row = status.Condition[i] = new ConditionType1();
                    ...
                    else
                    {
                        if (status.Condition == null)
                        {
                            status.Condition = new ConditionType1[1];
                            status.Condition[0] = new ConditionType1();
                        }
                        SetField(status.Condition[0], xmlMapping);
                    }
                    break;
        ...
        public void SetField(CreditNoteLineType creditnoteline, IXmlMapping xmlMapping)
        {
            var xmlNode = xmlMapping.GetXMLNode();
            ...
            {
                case "ID":
                    if (creditnoteline.ID == null)
                        creditnoteline.ID = new IDType();
                    SetField(creditnoteline.ID, xmlMapping);
                    break;
                case "UUID":
                    if (creditnoteline.UUID == null)
                        creditnoteline.UUID = new UUIDType();
                    SetField(creditnoteline.UUID, xmlMapping);
                    break;
                case "Note":
                    if (xmlMapping is IXmlCollectionMapping collMappingNote && !collMappingNote.HasNextNode)
                    {
                        if (creditnoteline.Note == null)
                            creditnoteline.Note = new NoteType[collMappingNote.Quantity];

                        for (int i = 0; i < collMappingNote.Quantity; i++)
                        {
                            var row = creditnoteline.Note[i] = new NoteType();
                    ...
                    else
                    {
                        if (creditnoteline.Note == null)
                        {
                            creditnoteline.Note = new NoteType[1];
                            creditnoteline.Note[0] = new NoteType();
                        }
                        SetField(creditnoteline.Note[0], xmlMapping);
                    }
                    break;
                case "CreditedQuantity":
                    if (creditnoteline.CreditedQuantity == null)
                        creditnoteline.CreditedQuantity = new CreditedQuantityType();
                    SetField(creditnoteline.CreditedQuantity, xmlMapping);
                    break;
                case "LineExtensionAmount":
                    if (creditnoteline.LineExtensionAmount == null)
                        creditnoteline.LineExtensionAmount = new LineExtensionAmountType();
                    SetField(creditnoteline.LineExtensionAmount, xmlMapping);
                    break;
                case "TaxPointDate":
                    if (creditnoteline.TaxPointDate == null)
                        creditnoteline.TaxPointDate = new TaxPointDateType();
                    SetField(creditnoteline.TaxPointDate, xmlMapping);
                    break;
                case "AccountingCostCode":
                    if (creditnoteline.AccountingCostCode == null)
                        creditnoteline.AccountingCostCode = new AccountingCostCodeType();
                    SetField(creditnoteline.AccountingCostCode, xmlMapping);
                    break;
                case "AccountingCost":
                    if (creditnoteline.AccountingCost == null)
                        creditnoteline.AccountingCost = new AccountingCostType();
                    SetField(creditnoteline.AccountingCost, xmlMapping);
                    break;
                case "PaymentPurposeCode":
                    if (creditnoteline.PaymentPurposeCode == null)
                        creditnoteline.PaymentPurposeCode = new PaymentPurposeCodeType();
                    SetField(creditnoteline.PaymentPurposeCode, xmlMapping);
                    break;
                case "FreeOfChargeIndicator":
                    if (creditnoteline.FreeOfChargeIndicator == null)
                        creditnoteline.FreeOfChargeIndicator = new FreeOfChargeIndicatorType();
                    SetField(creditnoteline.FreeOfChargeIndicator, xmlMapping);
                    break;
                case "InvoicePeriod":
                    if (xmlMapping is IXmlCollectionMapping collMappingInvoicePeriod && !collMappingInvoicePeriod.HasNextNode)
                    {
                        if (creditnoteline.InvoicePeriod == null)
                            creditnoteline.InvoicePeriod = new PeriodType[collMappingInvoicePeriod.Quantity];

                        for (int i = 0; i < collMappingInvoicePeriod.Quantity; i++)
                        {
                            var row = creditnoteline.InvoicePeriod[i] = new PeriodType();
                    ...
                    else
                    {
                        if (creditnoteline.InvoicePeriod == null)
                        {
                            creditnoteline.InvoicePeriod = new PeriodType[1];
                            creditnoteline.InvoicePeriod[0] = new PeriodType();
                        }
                        SetField(creditnoteline.InvoicePeriod[0], xmlMapping);
                    }
                    break;
                case "OrderLineReference":
                    if (xmlMapping is IXmlCollectionMapping collMappingOrderLineReference && !collMappingOrderLineReference.HasNextNode)
                    {
                        if (creditnoteline.OrderLineReference == null)
                            creditnoteline.OrderLineReference = new OrderLineReferenceType[collMappingOrderLineReference.Quantity];

                        for (int i = 0; i < collMappingOrderLineReference.Quantity; i++)
                        {
                            var row = creditnoteline.OrderLineReference[i] = new OrderLineReferenceType();
                    ...
                    else
                    {
                        if (creditnoteline.OrderLineReference == null)
                        {
                            creditnoteline.OrderLineReference = new OrderLineReferenceType[1];
                            creditnoteline.OrderLineReference[0] = new OrderLineReferenceType();
                        }
                        SetField(creditnoteline.OrderLineReference[0], xmlMapping);
                    }
                    break;
                case "DiscrepancyResponse":
                    if (xmlMapping is IXmlCollectionMapping collMappingDiscrepancyResponse && !collMappingDiscrepancyResponse.HasNextNode)
                    {
                        if (creditnoteline.DiscrepancyResponse == null)
                            creditnoteline.DiscrepancyResponse = new ResponseType[collMappingDiscrepancyResponse.Quantity];

                        for (int i = 0; i < collMappingDiscrepancyResponse.Quantity; i++)
                        {
                            var row = creditnoteline.DiscrepancyResponse[i] = new ResponseType();
                    ...
                    else
                    {
                        if (creditnoteline.DiscrepancyResponse == null)
                        {
                            creditnoteline.DiscrepancyResponse = new ResponseType[1];
                            creditnoteline.DiscrepancyResponse[0] = new ResponseType();
                        }
                        SetField(creditnoteline.DiscrepancyResponse[0], xmlMapping);
                    }
                    break;
                case "DespatchLineReference":
                    if (xmlMapping is IXmlCollectionMapping collMappingDespatchLineReference && !collMappingDespatchLineReference.HasNextNode)
                    {
                        if (creditnoteline.DespatchLineReference == null)
                            creditnoteline.DespatchLineReference = new LineReferenceType[collMappingDespatchLineReference.Quantity];

                        for (int i = 0; i < collMappingDespatchLineReference.Quantity; i++)
                        {
                            var row = creditnoteline.DespatchLineReference[i] = new LineReferenceType();
                    ...
                    else
                    {
                        if (creditnoteline.DespatchLineReference == null)
                        {
                            creditnoteline.DespatchLineReference = new LineReferenceType[1];
                            creditnoteline.DespatchLineReference[0] = new LineReferenceType();
                        }
                        SetField(creditnoteline.DespatchLineReference[0], xmlMapping);
                    }
                    break;
                case "ReceiptLineReference":
                    if (xmlMapping is IXmlCollectionMapping collMappingReceiptLineReference && !collMappingReceiptLineReference.HasNextNode)
                    {
                        if (creditnoteline.ReceiptLineReference == null)
                            creditnoteline.ReceiptLineReference = new LineReferenceType[collMappingReceiptLineReference.Quantity];

                        for (int i = 0; i < collMappingReceiptLineReference.Quantity; i++)
                        {
                            var row = creditnoteline.ReceiptLineReference[i] = new LineReferenceType();
                    ...
                    else
                    {
                        if (creditnoteline.ReceiptLineReference == null)
                        {
                            creditnoteline.ReceiptLineReference = new LineReferenceType[1];
                            creditnoteline.ReceiptLineReference[0] = new LineReferenceType();
                        }
                        SetField(creditnoteline.ReceiptLineReference[0], xmlMapping);
                    }
                    break;
                case "BillingReference":
                    if (xmlMapping is IXmlCollectionMapping collMappingBillingReference && !collMappingBillingReference.HasNextNode)
                    {
                        if (creditnoteline.BillingReference == null)
                            creditnoteline.BillingReference = new BillingReferenceType[collMappingBillingReference.Quantity];

                        for (int i = 0; i < collMappingBillingReference.Quantity; i++)
                        {
                            var row = creditnoteline.BillingReference[i] = new BillingReferenceType();
                    ...
                    else
                    {
                        if (creditnoteline.BillingReference == null)
                        {
                            creditnoteline.BillingReference = new BillingReferenceType[1];
                            creditnoteline.BillingReference[0] = new BillingReferenceType();
                        }
                        SetField(creditnoteline.BillingReference[0], xmlMapping);
                    }
                    break;
                case "DocumentReference":
                    if (xmlMapping is IXmlCollectionMapping collMappingDocumentReference && !collMappingDocumentReference.HasNextNode)
                    {
                        if (creditnoteline.DocumentReference == null)
                            creditnoteline.DocumentReference = new DocumentReferenceType[collMappingDocumentReference.Quantity];

                        for (int i = 0; i < collMappingDocumentReference.Quantity; i++)
                        {
                            var row = creditnoteline.DocumentReference[i] = new DocumentReferenceType();
                    ...
                    else
                    {
                        if (creditnoteline.DocumentReference == null)
                        {
                            creditnoteline.DocumentReference = new DocumentReferenceType[1];
                            creditnoteline.DocumentReference[0] = new DocumentReferenceType();
                        }
                        SetField(creditnoteline.DocumentReference[0], xmlMapping);
                    }
                    break;
                case "PricingReference":
                    if (creditnoteline.PricingReference == null)
                        creditnoteline.PricingReference = new PricingReferenceType();
                    SetField(creditnoteline.PricingReference, xmlMapping);
                    break;
                case "OriginatorParty":
                    if (creditnoteline.OriginatorParty == null)
                        creditnoteline.OriginatorParty = new PartyType();
                    SetField(creditnoteline.OriginatorParty, xmlMapping);
                    break;
                case "Delivery":
                    if (xmlMapping is IXmlCollectionMapping collMappingDelivery && !collMappingDelivery.HasNextNode)
                    {
                        if (creditnoteline.Delivery == null)
                            creditnoteline.Delivery = new DeliveryType[collMappingDelivery.Quantity];

                        for (int i = 0; i < collMappingDelivery.Quantity; i++)
                        {
                            var row = creditnoteline.Delivery[i] = new DeliveryType();
                    ...
                    else
                    {
                        if (creditnoteline.Delivery == null)
                        {
                            creditnoteline.Delivery = new DeliveryType[1];
                            creditnoteline.Delivery[0] = new DeliveryType();
                        }
                        SetField(creditnoteline.Delivery[0], xmlMapping);
                    }
                    break;
                case "PaymentTerms":
                    if (xmlMapping is IXmlCollectionMapping collMappingPaymentTerms && !collMappingPaymentTerms.HasNextNode)
                    {
                        if (creditnoteline.PaymentTerms == null)
                            creditnoteline.PaymentTerms = new PaymentTermsType[collMappingPaymentTerms.Quantity];

                        for (int i = 0; i < collMappingPaymentTerms.Quantity; i++)
                        {
                            var row = creditnoteline.PaymentTerms[i] = new PaymentTermsType();
                    ...
                    else
                    {
                        if (creditnoteline.PaymentTerms == null)
                        {
                            creditnoteline.PaymentTerms = new PaymentTermsType[1];
                            creditnoteline.PaymentTerms[0] = new PaymentTermsType();
                        }
                        SetField(creditnoteline.PaymentTerms[0], xmlMapping);
                    }
                    break;
                case "TaxTotal":
                    if (xmlMapping is IXmlCollectionMapping collMappingTaxTotal && !collMappingTaxTotal.HasNextNode)
                    {
                        if (creditnoteline.TaxTotal == null)
                            creditnoteline.TaxTotal = new TaxTotalType[collMappingTaxTotal.Quantity];

                        for (int i = 0; i < collMappingTaxTotal.Quantity; i++)
                        {
                            var row = creditnoteline.TaxTotal[i] = new TaxTotalType();
                    ...
                    else
                    {
                        if (creditnoteline.TaxTotal == null)
                        {
                            creditnoteline.TaxTotal = new TaxTotalType[1];
                            creditnoteline.TaxTotal[0] = new TaxTotalType();
                        }
                        SetField(creditnoteline.TaxTotal[0], xmlMapping);
                    }
                    break;
                case "AllowanceCharge":
                    if (xmlMapping is IXmlCollectionMapping collMappingAllowanceCharge && !collMappingAllowanceCharge.HasNextNode)
                    {
                        if (creditnoteline.AllowanceCharge == null)
                            creditnoteline.AllowanceCharge = new AllowanceChargeType[collMappingAllowanceCharge.Quantity];

                        for (int i = 0; i < collMappingAllowanceCharge.Quantity; i++)
                        {
                            var row = creditnoteline.AllowanceCharge[i] = new AllowanceChargeType();
                    ...
                    else
                    {
                        if (creditnoteline.AllowanceCharge == null)
                        {
                            creditnoteline.AllowanceCharge = new AllowanceChargeType[1];
                            creditnoteline.AllowanceCharge[0] = new AllowanceChargeType();
                        }
                        SetField(creditnoteline.AllowanceCharge[0], xmlMapping);
                    }
                    break;
                case "Item":
                    if (creditnoteline.Item == null)
                        creditnoteline.Item = new ItemType();
                    SetField(creditnoteline.Item, xmlMapping);
                    break;
                case "Price":
                    if (creditnoteline.Price == null)
                        creditnoteline.Price = new PriceType();
                    SetField(creditnoteline.Price, xmlMapping);
                    break;
                case "DeliveryTerms":
                    if (xmlMapping is IXmlCollectionMapping collMappingDeliveryTerms && !collMappingDeliveryTerms.HasNextNode)
                    {
                        if (creditnoteline.DeliveryTerms == null)
                            creditnoteline.DeliveryTerms = new DeliveryTermsType[collMappingDeliveryTerms.Quantity];

                        for (int i = 0; i < collMappingDeliveryTerms.Quantity; i++)
                        {
                            var row = creditnoteline.DeliveryTerms[i] = new DeliveryTermsType();
                    ...
                    else
                    {
                        if (creditnoteline.DeliveryTerms == null)
                        {
                            creditnoteline.DeliveryTerms = new DeliveryTermsType[1];
                            creditnoteline.DeliveryTerms[0] = new DeliveryTermsType();
                        }
                        SetField(creditnoteline.DeliveryTerms[0], xmlMapping);
                    }
                    break;
                case "SubCreditNoteLine":
                    if (xmlMapping is IXmlCollectionMapping collMappingSubCreditNoteLine && !collMappingSubCreditNoteLine.HasNextNode)
                    {
                        if (creditnoteline.SubCreditNoteLine == null)
                            creditnoteline.SubCreditNoteLine = new CreditNoteLineType[collMappingSubCreditNoteLine.Quantity];

                        for (int i = 0; i < collMappingSubCreditNoteLine.Quantity; i++)
                        {
                            var row = creditnoteline.SubCreditNoteLine[i] = new CreditNoteLineType();

                            foreach (var colMapp in collMappingSubCreditNoteLine.ColumnsMapping)
                            {
                                colMapp.SetRowContext(((XmlCollectionMapping)xmlMapping).itemsList.Rows[i]);
                                if (colMapp.Value != null && !string.IsNullOrEmpty(colMapp.Value.ToString()))
                                {
                    ...
                    else
                    {
                        if (creditnoteline.SubCreditNoteLine == null)
                        {
                            creditnoteline.SubCreditNoteLine = new CreditNoteLineType[1];
                            creditnoteline.SubCreditNoteLine[0] = new CreditNoteLineType();
                        }
                        SetField(creditnoteline.SubCreditNoteLine[0], xmlMapping);
                    }
                    break;
                case "ItemPriceExtension":
                    if (creditnoteline.ItemPriceExtension == null)
                        creditnoteline.ItemPriceExtension = new PriceExtensionType();
                    SetField(creditnoteline.ItemPriceExtension, xmlMapping);
                    break;
